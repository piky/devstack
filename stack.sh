...
if [[ -n "$LOGFILE" ]]; then
    ...
    if [[ "$VERBOSE" == "True" ]]; then
        ...
        # Set fd 6 to summary log file and send output from outfilter.py to
        # /dev/null so it doesn't keep outfilter.py above from terminating.
