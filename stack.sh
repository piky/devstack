...
if is_service_enabled swift; then
   ...
   sed -e "s,%SWIFT_CONFIG_LOCATION%,${SWIFT_CONFIG_LOCATION}," \
       -e "s,%USER%,$USER,;s,%SERVICE_TOKEN%,${SERVICE_TOKEN}," \
       -e "s,%KEYSTONE_SERVICE_PORT%,${KEYSTONE_SERVICE_PORT},g" \
       -e "s,%KEYSTONE_SERVICE_HOST%,${KEYSTONE_SERVICE_HOST},g" \
       -e "s,%KEYSTONE_AUTH_PORT%,${KEYSTONE_AUTH_PORT},g" \
       -e "s,%KEYSTONE_AUTH_HOST%,${KEYSTONE_AUTH_HOST},g" \
       -e "s,%KEYSTONE_AUTH_PROTOCOL%,${KEYSTONE_AUTH_PROTOCOL},g" \
       -e "s/%AUTH_SERVER%/${swift_auth_server}/" \
