...
EOF
    ...
    # octavia requires debootstrap package from epel
    yum-config-manager --save --setopt=includepkgs=debootstrap,dpkg epel
}
...
[virtualization-el8.0]
name=Virtualization EL8.0
baseurl=https://trunk.rdoproject.org/centos8-master/deps/advvirt/8.0/
enabled=1
gpgcheck=0
module_hotfixes=1
