...
if is_service_enabled keystone; then
    ...
    # Needed for swift CLI, we can remove this once
    # swift cli calls are removed from devstack
    export OS_AUTH_VERSION=$OS_IDENTITY_API_VERSION

    # These env vars are left for backwards compatibility, but will not
    # actually be used for authentication and should be removed.
