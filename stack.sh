...
# This vaiable allows you to configure how many replicas needs to be
# configured on your Swift cluster.  By default the three replicas
# would need a bit of IO and Memory you may want to lower that to 1 if
# you want to do only some quick testing.
