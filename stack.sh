...
if is_service_enabled g-api n-api; then
    ...
    configure_glance
    end_time=$(date +%s)
    echo "Completed configure glance in $((end_time - start_time)) seconds"
fi
...
if is_service_enabled cinder; then
    ...
    configure_cinder
    end_time=$(date +%s)
    echo "Completed configure cinder in $((end_time - start_time)) seconds"
fi
...
if is_service_enabled neutron; then
    ...
    end_time=$(date +%s)
    echo "Completed configure neutron in $((end_time - start_time)) seconds"
fi
...
if is_service_enabled nova; then
    ...
    configure_nova
    end_time=$(date +%s)
    echo "Completed pip_install in $((end_time - start_time)) seconds"
fi
...
if is_service_enabled horizon; then
    ...
    configure_horizon
    end_time=$(date +%s)
    echo "Completed configure horizon in $((end_time - start_time)) seconds"
fi
...
if is_service_enabled ceilometer; then
    ...
    end_time=$(date +%s)
    echo "Completed configure ceilometer in $((end_time - start_time)) seconds"
fi
