...
if is_service_enabled key; then
    ...
    export KEYSTONE_CATALOG_BACKEND=${KEYSTONE_CATALOG_BACKEND:-template}
    ...
    export SERVICE_ENDPOINT=$KEYSTONE_AUTH_PROTOCOL://$KEYSTONE_AUTH_HOST:$KEYSTONE_AUTH_PORT/v2.0
    SERVICE_TENANT_NAME=$SERVICE_TENANT_NAME SERVICE_HOST=$SERVICE_HOST S3_SERVICE_PORT=$S3_SERVICE_PORT \
