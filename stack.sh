...
if is_service_enabled q-svc; then
    ...
    if [[ -e $QUANTUM_DIR/etc/plugins.ini ]]; then
        ...
        Q_SERV_ARGS=/etc/quantum/quantum.conf
    else
        # Quantum common config support
        Q_SERV_ARGS=""
    fi
    ...
    # Update either configuration file with plugi or old plugin file
    ...
    screen_it q-svc "cd $QUANTUM_DIR && python $QUANTUM_DIR/bin/quantum-server $Q_SERV_ARGS"
fi
