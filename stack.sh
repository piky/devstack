...
# Enabled service check is done in the function
...
# Some Quantum plugins require network controllers which is not
# a part of OpenStack project. Configure and start them.
# Note that enabled service check is done in the function.
