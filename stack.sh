...
if [[ is_debian ]]; then
    ...
    # repository.
    echo 'deb http://ftparchive.gplhost.com grizzly-backports main' | sudo tee /etc/apt/sources.list.d/gplhost_wheezy-backports.list
    echo 'deb http://ftparchive.gplhost.com grizzly main' | sudo tee /etc/apt/sources.list.d/gplhost_wheezy-backports.list
    apt_get update
