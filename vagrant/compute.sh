...
function run_stack {
    sudo -E  -u stack cp /vagrant/localrc  /opt/stack/devstack/localrc
    sudo -E  -u stack cat << EOF >> /opt/stack/devstack/localrc
HOST_IP=$Host_ip
ENABLED_SERVICES=n-cpu,n-novnc,q-agt,cinder,c-vol
Q_DVR_MODE=dvr_snat
