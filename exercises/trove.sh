...
# Exercising datastores
DSTORE_ID=(trove datastore-list | tail -n +4 | head -3 | get_field 1)
die_if_not_set $LINENO DSTORE_ID "Trove API not functioning!"

# Exercising datastore versions
DS_VERSION_ID=(trove datastore-version-list $DSTORE_ID | tail -n +4 | get_field 1)
die_if_not_set $LINENO DS_VERSION_ID "Trove API not functioning!"
