...
die_if_not_zero "Failure associating address $FLOATING_IP to $INSTANCE"

# Authorize pinging
euca-authorize -P icmp -s 0.0.0.0/0 -t -1:-1 $SECGROUP
die_if_not_zero "Failure authorizing rule in $SECGROUP"
...
die_if_not_zero "Failure revoking rule in $SECGROUP"

# Release floating address
euca-disassociate-address $FLOATING_IP
die_if_not_zero "Failure disassociating address $FLOATING_IP"
...
die_if_not_zero "Failure releasing address $FLOATING_IP"
...
die_if_not_zero "Failure terminating instance $INSTANCE"
...
die_if_not_zero "Failure deleting security group $SECGROUP"
