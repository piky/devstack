...
ssh -i /tmp/snapshot_key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/nul $SSH_USER@$EXTERNAL_IP 'touch test_file'
...
CHECK_FOR_FILE=`ssh -i /tmp/snapshot_key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/nul $SSH_USER@$EXTERNAL_IP 'ls test_file'`
