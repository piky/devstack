...
nova aggregate-details $AGGREGATE_ID | egrep "availability_zone=$AGGREGATE_A_ZONE"
...
nova aggregate-details $AGGREGATE_ID | grep "availability_zone=$AGGREGATE_A_ZONE"
