...
die_if_not_zero "Failure adding floating IP $FLOATING_IP to $NAME"
...
die_if_not_zero "Failure deleting security group rule from $SECGROUP"
...
die_if_not_zero "Failure deleting floating IP $FLOATING_IP"

# Delete second floating IP
nova floating-ip-delete $TEST_FLOATING_IP
die_if_not_zero "Failure deleting floating IP $TEST_FLOATING_IP"

# shutdown the server
nova delete $VM_UUID
die_if_not_zero "Failure deleting instance $NAME"
