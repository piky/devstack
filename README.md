...
devstack also supports configuring the Neutron ML2 plugin. The simplest way to deploy devstack is with Open vSwitch agents using either VLAN or GRE tunnel networks. To configure this, enable the following in localrc:
...
Additional ML2 related configuration variables are shown below. These are used for more complex ML2 deployments wiht devstack:
