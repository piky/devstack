...
Multiple database backends are available. The available databases are defined in the
DATABASE\_BACKENDS variable in the stackrc file. To choose the database backend, add a line
to your `localrc` like:
