...
ALL_LIBS="$ALL_LIBS python-keystoneclient taskflow oslo.middleware pycadf"
ALL_LIBS="$ALL_LIBS python-glanceclient python-ironicclient tempest-lib"
ALL_LIBS="$ALL_LIBS oslo.messaging oslo.log cliff python-heatclient stevedore"
ALL_LIBS="$ALL_LIBS python-cinderclient glance_store oslo.concurrency oslo.db"
ALL_LIBS="$ALL_LIBS oslo.vmware keystonemiddleware oslo.serialization"
ALL_LIBS="$ALL_LIBS python-saharaclient django_openstack_auth"
ALL_LIBS="$ALL_LIBS python-openstackclient oslo.rootwrap oslo.i18n"
ALL_LIBS="$ALL_LIBS python-ceilometerclient oslo.utils python-swiftclient"
ALL_LIBS="$ALL_LIBS python-neutronclient tooz ceilometermiddleware oslo.policy"
ALL_LIBS="$ALL_LIBS debtcollector"
