...
Turn off paging to pipe the output to another tool, such as ``grep``. For
example, to find a server instance UUID in the nova logs::

  sudo journalctl -a --unit devstack@n-* --no-pager | grep 58391b5c-036f-44d5-bd68-21d3c26349e6
