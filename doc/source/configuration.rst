...
IP Version
    ...
    ::
        ...
        IPV6_PRIVATE_FIXED_RANGE=fd$IPV6_GLOBAL_ID::/64
        IPV6_PRIVATE_NETWORK_GATEWAY=fd$IPV6_GOLBAL_ID::1

    | *Note: ``IPV6_PRIVATE_FIXED_RANGE`` and ``IPV6_PRIVATE_NETWORK_GATEWAY``
