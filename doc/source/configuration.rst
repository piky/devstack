...
--------------------
  ...
  |   Enable the use of Python virtual environments by seting ``USE_VENV``
  ...
  |   Each entry in the ``PROJECT_VENV`` array contains the diretory name
  ...
  |   A comma-separated list of additiona packages to be installed into each
