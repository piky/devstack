...
NOTE: In this configuration we are defining FLOATING_RANGE to be a
...
TODO: check with others and see if others are dedicating a physical
device to OVS_PHYSICAL_BRIDGE
...
NOTE: In this configuration we are defining FIXED_RANGE to be a
subnet that exists in the private RFC1918 address space - however in
