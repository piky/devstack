...
Note extension driver of ML2 plugin is set by `Q_ML2_PLUGIN_EXT_DRIVERS`, and
it includes 'port_security' by defalut. If you want to remove all the extension
drivers even include the 'port_security', set `Q_ML2_PLUGIN_EXT_DRIVERS` to
blank.
