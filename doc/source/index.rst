...
Use devstack in your CI with :doc:`Ansible roles <roles>` and
:doc:`Jobs <jobs>` for Zuul V3. Migrate your devstack Zuul V2 jobs to Zuul V3
with this full migration :doc:`how-to <ci_jobs_migration>`.
