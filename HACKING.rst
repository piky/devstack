...
* If you want an excersice skipped when for example a service wasn't enabled
  for the exercise to be run, you can exit your exercise with the special
  signal 222 and it will be detected as skipped.
