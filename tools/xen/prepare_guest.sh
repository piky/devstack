...
DO_TGZ=${DO_TGZ:-1}
CC=${CC-us}
MIRROR=${MIRROR-$CC.archive.ubuntu.com}

# Sources.list
cat <<EOF >$STAGING_DIR/etc/apt/sources.list
deb http://$MIRROR/ubuntu/ oneiric main restricted
deb-src http://$MIRROR/ubuntu/ oneiric main restricted
deb http://$MIRROR/ubuntu/ oneiric-updates main restricted
deb-src http://$MIRROR/ubuntu/ oneiric-updates main restricted
deb http://$MIRROR/ubuntu/ oneiric universe
deb http://$MIRROR/ubuntu/ oneiric-updates universe
deb http://$MIRROR/ubuntu/ oneiric multiverse
deb http://$MIRROR/ubuntu/ oneiric-updates multiverse
EOF
