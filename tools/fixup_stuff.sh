...
if [[ -z "${reserved_ports}" ]]; then
    # If there are no currently reserved ports, reserve 35357
    sudo sysctl -w net.ipv4.ip_local_reserved_ports=${keystone_ports}
else
    # If there are currently reserved ports, keep those and also reserve 35357
    # Duplicate reservations are merged into a single reservation (or range)
