...
class UpdateCloudsYaml(object):
    def __init__(self, args):
        ...
        if args.os_sdk_example_tests_image_name:
            self._cloud_data['example'] = {
                'image_name': args.os_sdk_example_tests_image_name,
            }
...
def main():
    ...
    parser.add_argument('--os-sdk-example-tests-image-name')
